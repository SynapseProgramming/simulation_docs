...
\subsection{Generation of stl file}
...
test test
% TODO: write out this section once we have it figured out
\end{document}


% TODO: this is the file path for where the worlds are gazebo.
% /usr/share/gazebo-9/worlds


% TODO: add in documentation for launching the world using the given launch file in map2gazebo


% TODO: Add in documentation for using the given stl file.
